...
for (let i = 0; i < picArray.length; i++) {
  ...
  // Tuotti kyllä harmaita hiuksia tämä miksei kuvat aluksi näkyneet. Pienestä oli kiinni.
  img.setAttribute("src", picArray[i].image.large); // tässä oli ensin pelkkä picArray[i].large
